...
uploaded = files.upload()  # upload amphibian_cleaned.xlsx

import os
os.makedirs("data", exist_ok=True)
os.makedirs("models", exist_ok=True)
os.makedirs("outputs", exist_ok=True)
os.rename("amphibian_cleaned.xlsx", "data/amphibian_cleaned.xlsx")
...
"""## Train-Test Split
The dataset is split into 80% training and 20% test before any tuning. The test set is locked away and will not be used until the very end for final evaluation. Stratification ensures the class ratio is preserved in both sets.
"""
...
shutil.make_archive('hamza_outputs', 'zip', '.', 'models')
shutil.make_archive('hamza_outputs_csv', 'zip', '.', 'outputs')

files.download('hamza_outputs.zip')
files.download('hamza_outputs_csv.zip')
